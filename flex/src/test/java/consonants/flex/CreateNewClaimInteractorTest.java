...
/**
 * Interactor test for the CreateNewClaim use case using Mockito.
 */
...
public class CreateNewClaimInteractorTest {
    ...
    /**
     * Tests if the output claim result of the CreateNewClaim use case has the correct claim Id.
     */
    @Test
    ...
    /**
     * Tests if the output claim result of the CreateNewClaim use case has the incorrect claim Id.
     */
    @Test
